 ...
 * Widget de champ Date rendu par OWL, via owl/field_bridge.js. Input
 * natif type="date" : calendrier + format yyyy-mm-dd garanti par le
 * navigateur (valeur déjà ISO côté Odoo, aucune conversion nécessaire).
